...
struct AlertManagerBaseArgsBridging {
  ...
  static jsi::Array defaultInputsToJs(jsi::Runtime &rt, P10 value) {
    return bridging::toJs(rt, value);
  }
  static std::optional<bool> modalToJs(jsi::Runtime &rt, P11 value) {
    return bridging::toJs(rt, value);
  }
  static std::optional<bool> criticalToJs(jsi::Runtime &rt, P12 value) {
    return bridging::toJs(rt, value);
  }
#endif
  ...
  static jsi::Object toJs(
    ...
    if (value.defaultInputs) {
            result.setProperty(rt, "defaultInputs", bridging::toJs(rt, value.defaultInputs.value(), jsInvoker));
          }
    if (value.modal) {
            result.setProperty(rt, "modal", bridging::toJs(rt, value.modal.value(), jsInvoker));
          }
    if (value.critical) {
            result.setProperty(rt, "critical", bridging::toJs(rt, value.critical.value(), jsInvoker));
          }
          return result;
        }
      };
...
public:
  ...
  virtual void setIsSecondaryClickToShowDevMenuEnabled(jsi::Runtime &rt, bool enabled) = 0;
...
private:
  ...
  public:
    ...
    void setIsSecondaryClickToShowDevMenuEnabled(jsi::Runtime &rt, bool enabled) override {
      static_assert(
          bridging::getParameterCount(&T::setIsSecondaryClickToShowDevMenuEnabled) == 2,
          "Expected setIsSecondaryClickToShowDevMenuEnabled(...) to have 2 parameters");

      return bridging::callFromJs<void>(
          rt, &T::setIsSecondaryClickToShowDevMenuEnabled, jsInvoker_, instance_, std::move(enabled));
    }
